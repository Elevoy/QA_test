...
result_mp_s_exp = math.pow(item_1, 0.5)
# 18. Вывести result_mp_s_root в консоль.
print('18. result_mp_s_exp =', result_mp_s_exp)
...
result_m_floor = item_1//item_2
# 30. Вывести result_no_division_loss в консоль.
print('30. result_m_floor =', result_m_floor)
...
b_item_relult_substr = b_item_t - b_item_f
# 53. Вывести b_item_relult_subtr в консоль.
print('53. b_item_relult_substr =', b_item_relult_substr)
...
print('57. b_item_relult_division =', b_item_relult_division)
